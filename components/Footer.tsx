      ...
      <Container className="relative py-16">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-1">
              <a
                ...
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-cream/20 text-cream/60 transition hover:border-gold/60 hover:text-gold"
              >
        ...
        <div className="mt-8 flex flex-col gap-4 border-t border-cream/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="mr-1 text-xs text-cream/30">{t('footer.paymentTitle')}</span>
            {/* Bancontact */}
            <span className="rounded border border-cream/15 bg-cream/5 px-2 py-0.5 text-[10px] font-medium text-cream/50">
              Bancontact
            </span>
            {/* PayPal */}
            <span className="rounded border border-cream/15 bg-cream/5 px-2 py-0.5 text-[10px] font-medium text-cream/50">
