...
## Current
- Working on: Step 4 (wire webhook token to checkout + webhook routes)
- Iteration: 3
- Last action: Added MOLLIE_WEBHOOK_TOKEN to .env.example and lib/env.ts validation (required)
