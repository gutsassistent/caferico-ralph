...
export default async function LocationsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const locationsBreadcrumb = breadcrumbSchema([
    { name: 'Home', url: `https://caferico.be/${locale}` },
    { name: 'Verkooppunten', url: `https://caferico.be/${locale}/verkooppunten` },
  ]);
  ...
  return (
    <main className="min-h-screen bg-noir text-cream">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: jsonLd(locationsBreadcrumb) }}
      />
      {/* Hero */}
